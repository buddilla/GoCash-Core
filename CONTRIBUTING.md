Contributing to gocash Core
============================

The gocash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the gocash Core project, and is not to be
confused with overall gocash Network Protocol consensus changes.

Whether a pull request is merged into gocash Core rests with the project merge
...
Patches that change gocash consensus rules are considerably more involved than
...
Where a patch set proposes to change the gocash consensus, it must have been
...
The project leader is the release manager for each gocash Core release.
