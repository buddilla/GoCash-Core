Contributing to JADE Core
============================

The JADE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the JADE Core project, and is not to be
confused with overall JADE Network Protocol consensus changes.

Whether a pull request is merged into JADE Core rests with the project merge
...
Patches that change JADE consensus rules are considerably more involved than
...
Where a patch set proposes to change the JADE consensus, it must have been
...
The project leader is the release manager for each JADE Core release.
