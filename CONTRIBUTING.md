Contributing to Goods Core
============================

The Goods Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Goods Core project, and is not to be
confused with overall Goods Network Protocol consensus changes.

Whether a pull request is merged into Goods Core rests with the project merge
...
Patches that change Goods consensus rules are considerably more involved than
...
Where a patch set proposes to change the Goods consensus, it must have been
...
The project leader is the release manager for each Goods Core release.
