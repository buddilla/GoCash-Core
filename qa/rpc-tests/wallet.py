...
#   c) node1 mines 32 blocks, so now node 0 has 60001gocash, node 1 has 4250gocash, node2 has none.
#   d) node0 sends 601 gocash to node2, in two transactions (301 gocash, then 300 gocash).
