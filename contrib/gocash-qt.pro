...
RESOURCES += src/qt/gocash.qrc src/qt/gocash_locale.qrc

TRANSLATIONS += src/qt/locale/gocash_bg.ts \
                src/qt/locale/gocash_de.ts \
                src/qt/locale/gocash_en.ts \
                src/qt/locale/gocash_es.ts \
                src/qt/locale/gocash_fi.ts \
                src/qt/locale/gocash_fr.ts \
                src/qt/locale/gocash_it.ts \
                src/qt/locale/gocash_ja.ts \
                src/qt/locale/gocash_pl.ts \
                src/qt/locale/gocash_pt.ts \
                src/qt/locale/gocash_ru.ts \
                src/qt/locale/gocash_sk.ts \
                src/qt/locale/gocash_sv.ts \
                src/qt/locale/gocash_vi.ts \
                src/qt/locale/gocash_zh_CN.ts \
                src/qt/locale/gocash_zh_TW.ts
