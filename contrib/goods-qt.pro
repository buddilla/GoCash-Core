...
RESOURCES += src/qt/goods.qrc src/qt/goods_locale.qrc

TRANSLATIONS += src/qt/locale/goods_bg.ts \
                src/qt/locale/goods_de.ts \
                src/qt/locale/goods_en.ts \
                src/qt/locale/goods_es.ts \
                src/qt/locale/goods_fi.ts \
                src/qt/locale/goods_fr.ts \
                src/qt/locale/goods_it.ts \
                src/qt/locale/goods_ja.ts \
                src/qt/locale/goods_pl.ts \
                src/qt/locale/goods_pt.ts \
                src/qt/locale/goods_ru.ts \
                src/qt/locale/goods_sk.ts \
                src/qt/locale/goods_sv.ts \
                src/qt/locale/goods_vi.ts \
                src/qt/locale/goods_zh_CN.ts \
                src/qt/locale/goods_zh_TW.ts
