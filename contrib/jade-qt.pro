...
RESOURCES += src/qt/jade.qrc src/qt/jade_locale.qrc

TRANSLATIONS += src/qt/locale/jade_bg.ts \
                src/qt/locale/jade_de.ts \
                src/qt/locale/jade_en.ts \
                src/qt/locale/jade_es.ts \
                src/qt/locale/jade_fi.ts \
                src/qt/locale/jade_fr.ts \
                src/qt/locale/jade_it.ts \
                src/qt/locale/jade_ja.ts \
                src/qt/locale/jade_pl.ts \
                src/qt/locale/jade_pt.ts \
                src/qt/locale/jade_ru.ts \
                src/qt/locale/jade_sk.ts \
                src/qt/locale/jade_sv.ts \
                src/qt/locale/jade_vi.ts \
                src/qt/locale/jade_zh_CN.ts \
                src/qt/locale/jade_zh_TW.ts
