...
bool fTestNet = true; //Params().NetworkID() == CBaseChainParams::TESTNET;
...
{
    //gocash will hash in the transaction hash and the index number in order to make sure each hash is unique
