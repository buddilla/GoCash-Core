...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:9911", "127.0.0.1", 9911));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9911", "127.0.0.1", 9911));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9911", "::ffff:127.0.0.1", 9911));
    BOOST_CHECK(TestSplitHost("[::]:9911", "::", 9911));
    BOOST_CHECK(TestSplitHost("::9911", "::9911", -1));
    BOOST_CHECK(TestSplitHost(":9911", "", 9911));
    BOOST_CHECK(TestSplitHost("[]:9911", "", 9911));
...
{
    BOOST_CHECK(TestParse("127.0.0.1", "127.0.0.1:9911"));
    BOOST_CHECK(TestParse("127.0.0.1:9911", "127.0.0.1:9911"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:9911"));
    BOOST_CHECK(TestParse("::", "[::]:99119911");
    BOOST_CHECK(TestParse("[::]:9911", "[::]:9911"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:9911"));
