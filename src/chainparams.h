 ...
 * gocash system. There are three: the main network on which people trade gocash
...
public:
    ...
    int64_t StartMasternodGOCashments() const { return nStartMasternodGOCashments; }
...
protected:
    ...
    int64_t nStartMasternodGOCashments;
