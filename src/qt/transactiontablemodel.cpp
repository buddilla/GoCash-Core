...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted gocash to zgocash");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zgocash");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received gocash from zgocash");
    case TransactionRecord::ZerocoinSpend_Change_zgocash:
        return tr("Minted Change as zgocash from zgocash Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zgocash to gocash");
