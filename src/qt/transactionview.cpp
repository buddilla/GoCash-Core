                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Goods from zGoods"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGoods"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGoods));
