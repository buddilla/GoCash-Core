...
/** Utility functions used by the gocash Qt UI.
 */
namespace GUIUtil
{
...
// Render gocash addresses in monospace font
...
// Parse "gocash:" URI into recipient object, return true on successful parsing
