...
/** Utility functions used by the Goods Qt UI.
 */
namespace GUIUtil
{
...
// Render Goods addresses in monospace font
...
// Parse "goods:" URI into recipient object, return true on successful parsing
