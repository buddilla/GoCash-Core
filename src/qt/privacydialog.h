...
public:
    ...
    void setZgocashControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzgocash_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzgocash_clicked();
    void on_pushButtonZgocashControl_clicked();
