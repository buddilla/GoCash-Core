                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Goods Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Goods address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and goods: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGDS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Goods Core"), this);
    aboutAction->setStatusTip(tr("Show information about Goods Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Goods"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Goods addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Goods addresses"));
    ...
    openAction->setStatusTip(tr("Open a Goods: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Goods Core help message to get a list with possible Goods command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Goods Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Goods network", "", count));
}
...
{
    QString strTitle = tr("Goods Core"); // default title
