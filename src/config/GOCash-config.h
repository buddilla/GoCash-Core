/* src/config/gocash-config.h.  Generated from gocash-config.h.in by configure.  */
/* src/config/gocash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef gocash_CONFIG_H

#define gocash_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.gocash.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "gocash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "gocash Core 1.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gocash"
