/* src/config/jade-config.h.  Generated from jade-config.h.in by configure.  */
/* src/config/jade-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.jade.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "JADE Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "JADE Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "jade"
