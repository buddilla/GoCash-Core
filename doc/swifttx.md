...
* WebSocket: [https://github.com/jadeproject/insight-api-jade#web-socket-api](https://github.com/jadeproject/insight-api-jade#web-socket-api) 
* API: [https://github.com/jadeproject/insight-api-jade#swifttx-transactions](https://github.com/jadeproject/insight-api-jade#swifttx-transactions) 
...
By default, the JADE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the JADE Core daemon:
