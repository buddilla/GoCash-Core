...
In order to support loading of multiple wallets in goods-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is goods.cpp.
...
Changes to goods.cpp
----------------------
goods.cpp is the entry point into goods-qt, and as such, will require some minor modifications to provide hooks for
