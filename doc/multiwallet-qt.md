...
In order to support loading of multiple wallets in jade-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is jade.cpp.
...
Changes to jade.cpp
----------------------
jade.cpp is the entry point into jade-qt, and as such, will require some minor modifications to provide hooks for
