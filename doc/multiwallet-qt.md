...
In order to support loading of multiple wallets in gocash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gocash.cpp.
...
Changes to gocash.cpp
----------------------
gocash.cpp is the entry point into gocash-qt, and as such, will require some minor modifications to provide hooks for
